  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-[#A6A196] mt-2 leading-relaxed">
        Seu passaporte digital serÃ¡ liberado apÃ³s a confirmaÃ§Ã£o da
        organizaÃ§Ã£o.
      </p>

      <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
        <SummaryItem label="Piloto" value={result.fullName} />
        <SummaryItem label="VeÃ­culo" value={result.vehicle} />
        <SummaryItem
          label="Categoria"
      ...
      <p className="mt-3 text-[10px] uppercase tracking-widest text-[#6E6A60]">
        Estado de demonstraÃ§Ã£o Â· QR Code serÃ¡ gerado apÃ³s aprovaÃ§Ã£o do
        backend
      </p>
