  ...
  return (
    <Section id="home" innerRef={innerRef} bg={C.base} className="min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 text-center pt-24 pb-16">
        ...
        <h1
          className="ts-display leading-[0.85] uppercase"
          style={{
        ...
        >
          Drag Racing 201 metros / ⅛ de milha - No Prep
        </p>

        <p className="ts-mono uppercase tracking-[0.22em] mt-3" style={{ color: C.amber, fontSize: 11 }}>
          Terceira etapa 2026 · Tarumã · 26/09 das 10h às 18h
        </p>
...
function RealMap() {
  return (
    <div className="relative w-full aspect-[16/10] overflow-hidden" style={{ border: `1px solid ${C.line}`, borderRadius: 8 }}>
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3452.923485744837!2d-51.0253456!3d-30.067756!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95199bb6937e1935%3A0x6bba3bc30f9d9c22!2sAut%C3%B3dromo%20Internacional%20de%20Tarum%C3%A3!5e0!3m2!1spt-BR!2sbr!4v1715000000000!5m2!1spt-BR!2sbr"
        width="100%"
        height="100%"
        ...
        title="Mapa do Autódromo Internacional de Tarumã"
      />
    </div>
  );
}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 mt-16 items-start">
          ...
          <div>
            ...
            <p className="ts-mono uppercase tracking-[0.22em] text-[10px] mt-8 mb-3" style={{ color: C.textFaint }}>
              Inscrições e informações no WhatsApp
            </p>
            <div className="flex flex-col gap-2">
              <a className="inline-flex items-center gap-3 rounded-full px-4 py-3 text-sm transition-colors hover:bg-white/10" style={{ border: `1px solid ${C.line}`, color: C.text }} href="https://wa.me/5551999060748" target="_blank" rel="noreferrer">
                <MessageCircle size={17} color={C.green} /> WhatsApp Rodrigo
              </a>
              <a className="inline-flex items-center gap-3 rounded-full px-4 py-3 text-sm transition-colors hover:bg-white/10" style={{ border: `1px solid ${C.line}`, color: C.text }} href="https://wa.me/5551992974560" target="_blank" rel="noreferrer">
                <MessageCircle size={17} color={C.green} /> WhatsApp Vinícius
              </a>
            </div>
    ...
    <Section id="patrocinadores" innerRef={innerRef} bg={C.surface} className="py-28 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="flex flex-col items-center text-center">
          <div className="ts-display uppercase font-bold px-10 py-3 mb-4" style={{ background: C.red, color: "#fff", fontSize: "clamp(1.6rem,4.5vw,2.6rem)", letterSpacing: "0.02em", clipPath: "polygon(3% 0, 100% 0, 97% 100%, 0% 100%)", boxShadow: `0 10px 30px ${C.red}44` }}>Patrocinadores</div>
          <p className="ts-mono uppercase tracking-[0.3em] text-xs" style={{ color: C.textMute }}>Top Street RS — 3ª Etapa 2026</p>
        </div>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mt-16">
          {SPONSORS.map((s) => { const Icon = s.icon; return <div key={s.name} className="flex flex-col items-center justify-center text-center p-5 gap-2 transition-transform duration-200 hover:scale-[1.04]" style={{ background: "rgba(255,255,255,0.03)", border: `1px solid ${C.line}`, clipPath: "polygon(0 0, 100% 0, 100% 88%, 90% 100%, 0 100%)", minHeight: 130 }}><Icon size={22} color={C.amber} /><span className="ts-display uppercase text-xs font-semibold leading-tight">{s.name}</span><span className="ts-mono text-[9px] uppercase tracking-widest" style={{ color: C.textFaint }}>{s.tag}</span></div>; })}
        </div>
